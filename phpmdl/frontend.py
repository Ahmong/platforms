...
class Apache(Frontend):
    ...
    def configure(self, interpretor=None):
        ...
        security_src_file = os.path.join(self.application.get('source_directory'), 'phpmdl', 'frontend',
    ...
    def get_default_vhost_filepath(self):
        return os.path.join(self.application.get('source_directory'), 'phpmdl', 'frontend', 'apache', 'vhost.conf')
...
class ApacheModPHP(Apache):
    def get_default_vhost_filepath(self):
        return os.path.join(self.application.get('source_directory'), 'phpmdl', 'frontend', 'apache-mod-php', 'vhost.conf')
...
class Nginx(Frontend):
    ...
    def configure(self, interpretor=None):
        ...
        nginx_config_file = os.path.join(self.application.get('source_directory'), 'phpmdl', 'frontend', 'nginx', 'nginx.conf')
