    ...
    def configure(self, frontend):
        ...
        for version in php_versions:
            ...
            for template, target in templates_mapping.iteritems():
                shutil.copyfile(
                    os.path.join(self.application.get('source_directory'), 'phpmdl', 'interpretor', 'fpm',
...
class HHVM(Interpretor):
    ...
    def configure(self, frontend):
        ...
        for template, target in templates_mapping.iteritems():
            shutil.copyfile(
                os.path.join(self.application.get('source_directory'), 'phpmdl', 'interpretor', 'hhvm', template),
                target
            )
